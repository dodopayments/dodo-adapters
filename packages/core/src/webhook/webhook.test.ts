...
describe("handleWebhookPayload", () => {
  ...
  const eventHandlerMap: [string, keyof WebhookHandlerConfig][] = [
    ...
    ["abandoned_checkout.recovered", "onAbandonedCheckoutRecovered"],
    ["dunning.started", "onDunningStarted"],
    ["dunning.recovered", "onDunningRecovered"],
    ...
    ["credit.overage_reset", "onCreditOverageReset"],
    ["credit.manual_adjustment", "onCreditManualAdjustment"],
    ["credit.balance_low", "onCreditBalanceLow"],
    ["entitlement_grant.created", "onEntitlementGrantCreated"],
    ["entitlement_grant.delivered", "onEntitlementGrantDelivered"],
