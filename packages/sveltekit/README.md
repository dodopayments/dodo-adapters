...
The `getCustomerId` function in the Customer Portal handler receives the full SvelteKit event object, giving you access to:
...
- **RequestHandler** pattern instead of Next.js route handlers
