...
export type { WebhookHandlerConfig } from "@dodopayments/core/webhook";
...
export type ConvexWebhookHandlerConfig = Omit<
  WebhookHandlerConfig<GenericActionCtx<GenericDataModel>>,
  "webhookKey"
>;
 ...
 * ```
 */
export const createDodoWebhookHandler = (
  handlers: ConvexWebhookHandlerConfig,
) => {
